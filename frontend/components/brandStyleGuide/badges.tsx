  ...
  return (
    <div className="h-screen mt-16 mb-4">
      ...
      <p className="text-foreground/60">
        Compact status indicators. Six semantic variants
      </p>
      ...
      <Card>
        ...
        <CardContent className="bg-background/90 font-mono">
          <div className="flex flex-col gap-2">
            ...
            <p>
              &lt;<span className="text-success">Badge</span> variant =
              <span className="text">&quot;default&quot;</span>&gt;&lt;/ <span className="text-success">Badge</span>&gt;
            </p>
          </div>
        </CardContent>
      </Card>
