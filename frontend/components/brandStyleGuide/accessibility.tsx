  ...
  return (
    <div className="h-full mt-16 mb-4">
      ...
      <p className="text-foreground/60">
        ...
        <span className="text-primary">Full SMS</span>
      </p>
      ...
      <Card>
        <CardContent className="bg-background/90 font-mono rounded p-6">
          <div className="flex flex-col gap-2">
            ...
            <p className="pl-4">
              <span className="text-destructive">variant</span>=
              <span className="text-success">"ghost"</span>
            </p>
            <p className="pl-4">
              <span className="text-destructive">aria-label</span>=
              <span className="text-success">"Download spectrum data"</span>
            </p>
            <p>&gt;</p>
            <p className="pl-4">
